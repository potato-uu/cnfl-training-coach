...
| 目标 | 公式 | 示例（76kg） |
|---|---|---|
| 维持/赛季中 | 1.6 g/kg/天 | 122 g/天 |
| 赛前增肌 | 1.8 g/kg/天 | 137 g/天 |
| 减脂期 | 2.2 g/kg/天 | 167 g/天 |

- 每餐蛋白质目标：0.4–0.55 g/kg（约30–50g）
- 每餐必须达到亮氨酸阈值 2–3g（等效乳清蛋白25g / 鸡胸肉约35g）
- 每天4–5次蛋白质均匀分布优于少量大餐

### 9.2 训练日营养时机（3口诀）

**训练前（60–90分钟）：**
- 碳水：0.5–1g/kg（慢消化，燕麦/米饭）
- 蛋白：20–40g（乳清/鸡蛋）
- 脂肪：低（减慢消化）

**训练后窗口（0–2小时）：**
- 蛋白：0.4g/kg（立即补充，触发MPS）
- 碳水：0.5–1g/kg（快消化，补糖原）
- 水合：训练中每损失1kg体重，补充1.5L水

**睡前（30–60分钟）：**
- 酪蛋白或乳制品：30–40g（慢消化，夜间MPS）
...
```
=== 营养建议 ===
姓名: [name] | 体重: [weight]kg | 当前阶段: [phase]

每日蛋白质目标: [X]g/天 ([X/weight]g/kg)
每餐目标: 约[X]g蛋白质（含[Y]g亮氨酸）

--- 训练日时机 ---
训练前90min: 碳水[X]g + 蛋白[Y]g（举例: 米饭1碗 + 2个鸡蛋）
训练后立即:  蛋白[Y]g + 碳水[X]g（举例: 乳清1勺 + 香蕉）
睡前:        酪蛋白/牛奶[Y]g（举例: 希腊酸奶200g）
